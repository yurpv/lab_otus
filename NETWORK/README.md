...
> Так как домашний роутер имеет подсеть 192.168.0.0/16 и из за этого возникла проблема с развертыванием стенда, мне пришлось изменить на подсеть 172.16.0.0/16
```
...
# Generated by iptables-save v1.8.7 on Thu Jun 27 13:38:56 2024
*filter
:INPUT ACCEPT [236:45591]
:FORWARD ACCEPT [0:0]
:OUTPUT ACCEPT [292:37197]
...
# Generated by iptables-save v1.8.7 on Thu Jun 27 13:38:56 2024
*nat
:PREROUTING ACCEPT [5:1316]
:INPUT ACCEPT [3:164]
:OUTPUT ACCEPT [34:2224]
