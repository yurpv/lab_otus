...
![image](https://github.com/user-attachments/assets/abf95e1a-383f-4ccf-b78a-c892863b6cc9)
...
Srvmon | сервер мониторига Prometheus + Alertmanager, для оповещения используется telegam, за визуализацию отвечает Grafana, сервер сбора логов, настроен с помощью Rsyslog
